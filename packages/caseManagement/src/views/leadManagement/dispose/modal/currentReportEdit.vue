<template>
	...
	<div class="backplane">
		<div class="backplane-Content">
			<el-form label-position="top" ref="currentReportForm" :model="currentReportForm" class="form-label-top">
				<el-collapse v-model="activeNames" class="collapse">
					...
					<el-collapse-item id="menu3" name="3">
						...
						<div class="form-content">
							<el-row :gutter="20">
								<el-col :span="6">
									<el-form-item label="报告文号:" prop="reportNum"><el-input v-model="currentReportForm.reportNum"></el-input></el-form-item>
								</el-col>
								<el-col :span="6">
								...
								<el-col :span="6">
									<el-form-item label="报告时间:" prop="reportTime">
										<el-date-picker v-model="currentReportForm.reportTime" type="date" value-format="yyyy-MM-dd"></el-date-picker>
									</el-form-item>
								</el-col>
							</el-row>
						</div>
