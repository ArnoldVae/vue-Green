...
//    import AuditAdvice from "./modal/auditAdvice.vue";
    ...
    @Component({
        ...
        components: { CaseSupplement,CaseDetails,Consideration,Marking,AuditOpinion,Conversation,Audit,Acceptance,FallbackRecord,Material,TakeAdvice,ReviewSession,FileRecord,AuditTalk },
        data() {
            return {
                form:{}
            };
