  ...
  <!-- <div class="dialog">
    ...
    <div class="body-container">
            <el-collapse v-model="activeNames">
                            ...
                            <el-row >
                                    <el-col :span="24">
                                        <el-form-item label="申诉理由:">
                                            <!-- <el-input type="textarea" :row="3" placeholder="请输入内容"> </el-input>-->
                                            <textarea autocomplete="off" row="3" placeholder="请输入内容" class="el-textarea__inner" style="min-height: 33px;height: 80px;"></textarea>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                        </el-form>
                ...
                <el-collapse-item id="menu2" title="办理情况" name="2">
                    <div class="form-content">
                        <el-form  class="form-label-top" label-position='top' :model="form" :rules="rules">
                            <el-row>
                                <el-col :span="6">
                                    <el-form-item label="转为申诉案件:" >
                                        <el-radio-group v-model="form.resource">
                                            <el-radio label="是"></el-radio>
                                            <el-radio label="否"></el-radio>
                                            </el-radio-group> 
               ...
               <el-collapse-item  id="menu1" title="督办情况" name="1" >
                    <div class="form-content">
                        <el-form  class="form-label-top" label-position='top' :model="form" :rules="rules">
                            <el-row >
                                <el-col :span="6">
                                ...
                                <el-col :span="6">
                                    <el-form-item label="反馈时间时间:" >
                                        <el-date-picker type="date" placeholder="选择日期" v-model="form.date1" style="width: 100%;"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                                    <el-form-item label="是否经过检查:" >
                                        <el-radio-group v-model="form.resource">
                                            <el-radio label="是"></el-radio>
                                            <el-radio label="否"></el-radio>
                                        </el-radio-group> 
                                ...
                                <el-col :span="6">
                                    <el-form-item label="二次复查机关:" >
                                        <el-input v-model="form.name"> </el-input> 
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                                    <el-form-item label="二次复查时间:" >
                                        <el-date-picker type="date" placeholder="选择日期" v-model="form.date1" style="width: 100%;"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
           ...
           <div slot="footer" class="body-footer">
