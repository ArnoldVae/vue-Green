  ...
  <!-- <div class="dialog">
    ...
    <div class="body-container">
            <el-collapse v-model="activeNames">    
                ...
                <el-collapse-item id="menu2" title="审核意见" name="2">
                    <div class="form-content">
                        <el-form  class="form-label-top" label-position='top' :model="form" :rules="rules">
                            <el-row>
                                
                                <el-col :span="6">
                                    <el-form-item label="事实是否清楚证据确实是否充分:" >
                                        <el-radio-group v-model="form.resource">
                                            <el-radio label="是" size="medium"></el-radio>
                                            <el-radio label="否" size="medium"></el-radio>
                                        </el-radio-group>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                                    <el-form-item label="适用法规规定和定性是否准确:">
                                        <el-radio-group v-model="form.resource">
                                            <el-radio label="是" size="medium"></el-radio>
                                            <el-radio label="否" size="medium"></el-radio>
                                        </el-radio-group>
                                ...
                                <el-col :span="6">
                                    <el-form-item label="手续是否完备程序是否符合规定:" >
                                        <el-radio-group v-model="form.resource">
                                            <el-radio label="是" size="medium"></el-radio>
                                            <el-radio label="否" size="medium"></el-radio>
                                        </el-radio-group>
               ...
               <el-collapse-item  id="menu1" title="复议报告" name="1" >
                    <div class="form-content">
                        <el-form  class="form-label-top" label-position='top' :model="form" :rules="rules">
                            <el-row>
                              <el-col :span="6">
                                    <el-form-item label="复议录入人:" prop="name">
                                        <el-input v-model="form.name"> </el-input> 
                                    </el-form-item>
                                </el-col>
                            
                                <el-col :span="6">
                                    <el-form-item label="复议时间:" prop="name">
