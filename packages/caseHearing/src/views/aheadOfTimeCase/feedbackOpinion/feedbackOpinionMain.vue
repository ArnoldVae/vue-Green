...
<!-- 反馈意见-提前介入 -->
    <div>
                ...
                <el-card class="box-card2" v-for="(item,index) in showCases" :key="index">
                    ...
                    <div  class="card-bottom-btn">
                        <el-row >
                            ...
                            <el-col :span="8" style="margin: 10px 0" v-if="item.caseState == '1'"><el-button class="minist-btn"  size="mini"  round @click="feedbackOpinion(item)" > 反馈意见</el-button></el-col>
        ...
        <el-dialog class="mc-dialog-big " title="反馈意见" :visible.sync="feedbackOpinionPage" width="100%" top="0">
            <FeedbackOpinionPage @submitEvent = closeFtn ></FeedbackOpinionPage>
        </el-dialog>
...
<script lang="ts">
    ...
    import FeedbackOpinionPage from "./modal/feedbackOpinionPage.vue";//反馈意见
    import StateLine from "../../pubicMAndC/modal/stateLine.vue";  //详情 案件轨迹
    @Component({
        name : "execution",
        components: {ViewDetailsWindow,FeedbackOpinionPage ,StateLine,CaseArchivePage},
        data() {
            return {};
        },
    ...
    export default class formAudit extends Vue {
        showTabs ={
            ...
            groupDeliberationsPage:true,//集体审议
            approvalLeaderPage:true//报批领导
    	};
        showCases = [];
        allCases: any = [
            {
        ...
        feedbackOpinionPage:boolean = false
...
//        节点详情
        ...
        mounted() {
         ...
         closeFtn(){
        		this.feedbackOpinionPage = false;
        }
    }
</script>
