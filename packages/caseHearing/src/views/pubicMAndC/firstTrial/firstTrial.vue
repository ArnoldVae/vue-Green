<template style="background: #f1f1f1">
    <div>
                ...
                <el-card class="box-card2" v-for="(item,index) in showCases" :key="index">
                    ...
                    <div class="card-bottom-btn">
                        <el-row>
                            ...
                            <el-col :span="8" style="margin: 5px 0">
                                <el-button class="minist-btn" size="mini" round @click="fistTrailModal=true">案件受理
                                </el-button>
                            </el-col>
                        </el-row>
                    </div>
        ...
        <el-dialog title="案件详情" :visible.sync="caseSupplementFlag" class="mc-dialog-big" width="100%" top="0">
            <caseRegister ref="caseReg"  v-bind:myData="source"></caseRegister>
        </el-dialog>
        ...
        <el-dialog class="mc-dialog-big jwjw-dialog-big"  title="案件详情" :visible.sync="caseDetailsFlag" width="100%" top="0">
            <CaseTotal  v-bind:myData="showTabs"></CaseTotal>
        </el-dialog>
        ...
        <el-dialog class="mc-dialog-big jwjw-dialog-big"  title="案件受理" :visible.sync="fistTrailModal" width="100%" top="0" style="background: #ffffff">
            <FirstTrailModal @submitEvent="FatherParam"></FirstTrailModal>
...
<script lang="ts">
    ...
    import caseRegister from '../../evocatoryRes/modal/caseRegister1';
    import StateLine from "../modal/stateLine.vue";

    import FirstTrailModal from "../modal/firstTrialModal.vue";
    //import CaseTotal from "../../pubicMAndC/modal/caseTotalDetail.vue"; //案件详情
    @Component({
        name: "formAudit",
        source:{},
        components: {caseRegister, StateLine,FirstTrailModal},
        data() {
            return {
                form: {}
            };
