           ...
           <div class="box">
               <div class="box_title">
                   <el-radio-group v-model="isCollapse" style="margin-top: 10px; background: #f6f6f6;">
                       ...
                       <el-radio-button label="left">报批领导</el-radio-button>


                   </el-radio-group>
                   <div v-show="isCollapse=='left'">
                       <LeaderShip pageFlag="aheaad" ref="mychild"></LeaderShip>
                   </div>
                   <div v-show="isCollapse=='other'">
                       <Deliberations  pageFlag="aheaad"></Deliberations>
                   </div>
...
import LeaderShip from "./leaderShip.vue";//报批领导
...
@Component({
  ...
  components: {LeaderShip,Deliberations},
  data() {
    return {
        options: [{
          value: '1',
