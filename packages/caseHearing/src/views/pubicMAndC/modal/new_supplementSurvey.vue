        ...
        <div class="backplane-Content margin-0">
            <el-collapse v-model="activeNames1" class="collapse">
                <el-collapse-item id="menu1" name="menu1">
                    <template slot="title">
                        <i class="header-icon el-icon-document"></i> <span class="title">补充调查</span>
                    </template>
                    <div class="form-content">
                        <el-form class="form-alive-label-top" label-position='top' :model="form">
                            <!--只有回写的表格form-disabled-label-top-->
                            <!--<el-form class="form-disabled-label-top" label-position='top' :model="form" >-->
                            <el-row :gutter="20">
                                <el-col :span="18">
                                    <el-form-item label="调查时间：" prop="name5">
                                        <el-date-picker
                ...
                <el-collapse-item id="menu2" name="menu2">
                    ...
                    <div class="form-content" style="padding: 0">
                        <div class="my-file-table">
                            <div class="item-main">
                                <el-row>
                                    <el-col :span="14" class="col-title"><p>调查材料</p></el-col>
                                    <el-col :span="3">
                                        <el-upload
                                                class="upload-demo"
                                                ...
                                                :file-list="fileList">
                                            <el-button size="small" type="primary"><i class="el-icon-upload"></i> 本地上传
                                            </el-button>
                                        </el-upload>
                                    </el-col>
                                    <el-col :span="3">
                                        <el-upload
                                                ...
                                                :on-exceed="handleExceed"
                                                :file-list="fileList">
                                            <el-button size="small" type="success"><i class="el-icon-printer"></i> 扫描上传
                                            </el-button>
                                        </el-upload>
                                    </el-col>
                                    <el-col :span="3">
                                        <el-upload
                                                ...
                                                :on-exceed="handleExceed"
                                                :file-list="fileList">
                                            <el-button size="small" type="warning"><i class="el-icon-picture"></i>高拍仪上传
                                            </el-button>
                                        </el-upload>
                                    </el-col>
                                </el-row>
                                <el-row v-for="(f,index) in fileList">
                                    <el-col :span="16" class="text-left"><span>文件{{index + 1}}：{{f.name}}</span>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-button size="small"><i class="el-icon-download"></i>下载</el-button>
                                        <el-button size="small"><i class="el-icon-search"></i>查看</el-button>
                                        <el-button size="small" @click="beforeRemove(index)"><i
