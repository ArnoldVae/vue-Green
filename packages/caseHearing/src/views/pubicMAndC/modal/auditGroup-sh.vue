    ...
    <div class="body-container-jwjw">
        <div class="body-container1">
            <el-radio-group v-model="isCollapse" style="margin-top: 10px; background: #f6f6f6;">
                <!--<el-radio-button label="other">审核谈话</el-radio-button>-->
...
<script lang="ts">
    ...
    import AuditAdvice from './auditAdvice-sh.vue'
    import AuditSoutdown from './audit_Shoutdown-sh.vue'

    @Component({
        props: ['pageFlag'],
        components: {AuditAdvice,AuditSoutdown},
        data() {
            return {
                options5: [{
                    value: '1',
