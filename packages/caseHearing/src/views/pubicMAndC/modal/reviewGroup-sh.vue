            ...
            <div class="box">
                <div class="box_title">
                    <el-radio-group v-model="isCollapse" style="margin-top: 10px; background: #f6f6f6;">
                        ...
                        <el-radio-button label="left" v-show="pageFlag=='leader'">领导签批</el-radio-button>
                        <el-radio-button label="right"v-show="pageFlag!='leader'">会议审议</el-radio-button>
                    </el-radio-group>
                    <div v-show="isCollapse=='left'">
                        <LeaderShip pageFlag="review"></LeaderShip>
                    </div>
...
<script lang="ts">
    ...
    @Component({
        ...
        components: {LeaderShip,Deliberations,ViewResults,Conference},
        data() {
            return {
                options: [{
                    value: '1',
