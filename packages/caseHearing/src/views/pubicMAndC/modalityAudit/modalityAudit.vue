...
<template style="background: #f1f1f1">
    <div>
        ...
        <!--<el-dialog title="查看详情" :visible.sync="caseDetailsFlag" class="mc-dialog-big"  width="100%" top="0">
            <CaseSupplement></CaseSupplement>
        </el-dialog>-->
        <el-dialog class="mc-dialog-big jwjw-dialog-big"  title="案件详情" :visible.sync="caseDetailsFlag" width="100%" top="0">
            <CaseTotal  v-bind:myData="showTabs" ref="caseReg" ></CaseTotal>
        </el-dialog>
        <el-dialog class="mc-dialog-big" title="初步审核" :visible.sync="formAuditFlag" width="100%" top="0" id="formAudit">
            <CaseFormAudit @submitEvent = closeFtn v-show="centerDialogVisible"></CaseFormAudit>
...
<script lang="ts">
    ...
    import CaseFormAudit from "../modal/caseFormAudit.vue";
    import CaseTotal from "../../pubicMAndC/modal/caseTotalDetail.vue"; //案件详情

    @Component({
        name: "formAudit",
        source:{},
        components: { CaseFormAudit, StateLine,CaseTotal},
        data() {
            return {
                form: {}
            };
