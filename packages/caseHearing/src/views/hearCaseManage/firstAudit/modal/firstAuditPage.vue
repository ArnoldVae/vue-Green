  ...
  <div class="backplane">
    ...
    <div class="backplane-Content">
	    <el-form class="form-label-top" label-position='top' :model="form">
	    		<el-row :gutter="24">
	    			<el-col :span="24" ref="checkboxDiv"><!--this.$refs.checkboxDiv.offsetHeight-->
    ...
    <!--<div slot="footer" v-show="pageFlag!='total'" class="backplane-footer-centerl" style="text-align: center">
    ...
    <!--<div slot="footer" v-show="pageFlag!='total'" class="backplane-footer-center">
			<div class="footer-btn-grunp">
