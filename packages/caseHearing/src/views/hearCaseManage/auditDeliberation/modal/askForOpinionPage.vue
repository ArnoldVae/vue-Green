				...
				<div class="form-content">
					<el-form class="form-label-top" label-position='top' :model="form" :rules="rules">
						<el-row :gutter="20">
									...
									<el-row :gutter="20">
										...
										<el-col :span="6">
											<el-form-item label="征求意见时间：">
												<el-date-picker type="date" placeholder="选择日期" v-model="form['date1'+index]" style="width: 100%;"></el-date-picker>
											</el-form-item>
										</el-col>
									...
									<el-row :gutter="20">
										<el-col :span="24">
											<el-form-item label="征求意见：" prop="name10">
												<el-input type="textarea" :autosize="{ minRows: 4}" v-model="form['name1'+index]" placeholder="请输入内容"></el-input>
											</el-form-item>
										</el-col>
									</el-row>
								</div>
							...
							<el-col :span="24">
								<div class="addAdvice" @click="addAdvice">
									<div style="font-size: 14px; font-weight: bold;color: #2f76dd;">+新增征求意见</div>
								</div>
							</el-col>
						</el-row>
					</el-form>
