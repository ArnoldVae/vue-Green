                                ...
                                <el-col :span="6">
                                    <el-form-item label="审议结果:" >
                                        <el-radio-group v-model="form.resource" @change="show">>
                                            <el-radio  label="01"> 审理继续</el-radio>
                                            <el-radio  label="02">审理通过</el-radio>
                                        </el-radio-group> 
                                    </el-form-item>
                                </el-col>
                                </el-row>
                                <el-row v-show="form.resource=='02'">
                                     <el-col :span="6">
                                        <el-form-item label="党纪处分:">
                                        <el-select class="form_select" v-model="form.region" placeholder="请选择">
                                        <el-option v-for="(option,index) in native" :key="index"
                                        v-bind:label="option.value"
                                        v-bind:value="option.code"></el-option>
                                        </el-select>
                                        </el-form-item>
                                ...
                                <el-col :span="6">
                                    <el-form-item label="是否需要报批:" >
                                        <el-radio-group v-model="form.resource">
                                            ...
                                            <el-radio label="向本级党委报批"></el-radio>
                                        </el-radio-group> 
                                    </el-form-item>
                                </el-col>
                                </el-row>
...
@Component({
  ...
  data() {
    return {
      ...
      nativeList:[{code:"01", value:"军委纪委专题会"}, {code:"01", value:"军委纪委全体会议"}, {code:"01", value:"中央军委常务会"},{code:"01", value:"中央政治局常务会议"},{code:"01", value:"中央纪委全体会议"},{code:"01", value:"中央全体会议"}],
//        职级列表（下拉）
