                            ...
                            <el-row :gutter="20">
                                    <el-col :span="24">
                                         <el-tabs v-model="activeName">
                                            <el-tab-pane label="案件来源及调查情况" name="first">
                                                <el-input type="textarea" v-model="form.desc"></el-input>
                                            </el-tab-pane>
                                            <el-tab-pane label="主要违纪违法事实" name="second">
                                                <el-input type="textarea" v-model="form.desc"></el-input>
                                            </el-tab-pane>
                                            <el-tab-pane label="被审查人态度和认识" name="third">
                                                <el-input type="textarea" v-model="form.desc"></el-input>
                                            </el-tab-pane>
                                            <el-tab-pane label="涉案款物情况" name="fourth">
                                                <el-input type="textarea" v-model="form.desc"></el-input>
                                            </el-tab-pane>
