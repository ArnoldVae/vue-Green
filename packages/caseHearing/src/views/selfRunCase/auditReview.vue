...
<template>
  <div>
    ...
    <div class="cards2">
      <el-row :gutter="20">
        <el-card class="box-card2" v-for="(item,index) in showCases" :key="index">
          <div class="title_state" v-if="item.caseState == '3'"><img src="img/corner.png" alt=""> <span>待签收</span></div>
          <div class="title_state" v-if="item.caseState == '4'&&item.btnFlag!='1'"><img src="img/corner2.png" alt=""> <span>审核中</span></div>
          <div class="title_state" v-if="item.caseState == '2'||item.btnFlag=='1'"><img src="img/corner2.png" alt=""> <span>审议中</span></div>
          <div class="title_state" v-if="item.link == '012' "><img src="img/corner2.png" alt=""> <span>已暂停</span></div>
          ...
          <div class="case_content">
            <el-form ref="form" :model="form" label-width="120px"  >
              ...
              <el-form-item label="案件登记时间" style="margin-bottom: 0">
                {{item.registrationTime}}
              </el-form-item>
              <el-form-item label="案件审理期限" style="margin-bottom: 0">
          ...
          <div class="card-bottom">
            ...
            <span v-if="item.caseState == '3'&&item.btnFlag!='1'" >当前节点：受理签收</span>
            <span v-if="item.caseState == '4'&&item.btnFlag!='1'" >当前节点：案件审核</span>
            <span v-if="item.caseState == '2'||item.btnFlag=='1'" >当前节点：案件审议</span>
    ...
    <el-dialog class="mc-dialog-big" title="查看详情" :visible.sync="dialogFlag.caseDetails" width="100%" top="0">
      <case-details></case-details>
    </el-dialog>
    <el-dialog  class="mc-dialog-big" title="形式审核" :visible.sync="dialogFlag.audit" width="100%" top="0">
      <CaseSupplement></CaseSupplement>
    </el-dialog>
    <el-dialog class="mc-dialog-big" title="会议审议" :visible.sync="dialogFlag.huiYi" width="100%" top="0">
      <ReviewSession></ReviewSession>
    </el-dialog>
    <el-dialog class="mc-dialog-big" title="征求意见" :visible.sync="dialogFlag.zhebgQiu" width="100%" top="0">
      <TakeAdvice></TakeAdvice>
    </el-dialog>
    <el-dialog class="mc-dialog-big" title="案件受理" :visible.sync="dialogFlag.acceptance" width="100%" top="0">
      <CaseSupplement></CaseSupplement>
    </el-dialog>
    <el-dialog class="mc-dialog-big" title="回退记录" :visible.sync="dialogFlag.fallbackRecord" width="100%" top="0">
      <CaseSupplement></CaseSupplement>
    </el-dialog>
    <el-dialog class="mc-dialog-big" title="审议意见" :visible.sync="dialogFlag.deliberations" width="100%" top="0">
      <Deliberations></Deliberations>
    </el-dialog>
    <el-dialog class="mc-dialog-big" title="阅卷笔录" :visible.sync="dialogFlag.fileRecord" width="100%" top="0">
      <FileRecord></FileRecord>
    </el-dialog>
      <el-dialog class="mc-dialog-big" title="审核意见" :visible.sync="dialogFlag.auditAdvice" width="100%" top="0">
      <AuditAdvice></AuditAdvice>
    </el-dialog>
     <el-dialog class="shenli mc-dialog-big" title="审理谈话" :visible.sync="dialogFlag.auditTalk" width="100%"  top="0">
     <AuditTalk></AuditTalk>
  </el-dialog>
  </div>
</template>
...
import Deliberations from "./modal/deliberations.vue";
...
@Component({
  name : "auditReview",
  components: { CaseSupplement,CaseDetails,Consideration,Marking,AuditOpinion,Conversation,Audit,Acceptance,FallbackRecord,Material,TakeAdvice,ReviewSession,Deliberations,FileRecord,AuditAdvice,AuditTalk },
  data() {
    return {
        form:{}
    };
