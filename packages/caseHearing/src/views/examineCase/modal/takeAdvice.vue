  ...
  <div class="dialog">
    ...
    <div onscroll="scrollFunc()" style="text-align: center;margin-left: 10%; margin-right:10%">
      <el-main >
          ...
          <el-collapse-item  id="menu1" title="征求意见信息" name="1" >
                    <div class="form-content">
                        <el-form label-position='top' :model="form" :rules="rules">
                            <el-row>
                              <el-col :span="6">
                                ...
                                <el-col :span="6">
                                    <el-form-item label="征求意见时间:" prop="name">
                            ...
                            <el-row>
                                <div style="border:1px dashed #CCCCCC ;height: 102px;border-radius:3px 4px 5px 6px" id="resTab">
                                    <div  @click="creadTab()"><i class="el-icon-plus" style="padding-top: 45px;padding-left: 400px;">新增征求意见</i></div>
                                </div>
                            </el-row>
                        </el-form>
                    </div>
                        ...
                        <el-collapse-item id="menu2" title="上传附件" name="2">
