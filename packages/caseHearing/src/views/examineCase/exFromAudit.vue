                ...
                <el-card class="box-card2" v-for="(item,index) in showCases" :key="index">
                    ...
                    <div class="card-bottom-btn">
                        <el-row >
                            ...
                            <el-col :span="8" style="margin: 5px 0" v-if="item.caseState == '1'"><el-button class="minist-btn"  size="mini"  round @click="formAudit(item)" >形式审核</el-button></el-col>
                            <el-col :span="8" style="margin: 5px 0" v-if="item.caseState != '1'"><el-button class="minist-btn" size="mini"  round @click="rollbackRecord(item)">回退记录</el-button></el-col>
                        </el-row>
                    </div>
