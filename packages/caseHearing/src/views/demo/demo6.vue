<template>
    <div class="page-one">
        ...
        <div style="margin-top: 40px">
            ...
            <iframe v-if="showPdf" id='previewPdf' :src="'/static/pdf/web/viewer.html?file=' + fileUrl" height="100%"
                    width="100%">
            </iframe>
        </div>
        <!--canvas-->
        ...
        <!--<md-contract :visible="contractVisable"-->
                     ...
                     <!--@handleModal="close">-->
        <!--</md-contract>-->
        <button @click="hhe();">hehhehehehhehehe</button>
        <iframe  id='pdfnewShow' height="100%"
                    width="100%">
            </iframe>
    </div>
</template>
