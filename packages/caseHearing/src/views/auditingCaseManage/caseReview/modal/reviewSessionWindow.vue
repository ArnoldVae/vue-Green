  ...
  <div class="backplane">
        <div class="page-tabs">
                   ...
                   <div v-show="isCollapse=='right'">
                       <ReviewSessionPage pageFlag="review"></ReviewSessionPage>
                   </div>
...
//import ViewResults from "../../pubicMAndC/modal/viewResults.vue";//重启审理 
 ...
 import ReviewSessionPage from "./reviewSessionPage.vue";//会议审议
@Component({
    props:['pageFlag'],
    selectData:selectData,
  components: {GroupDeliberation,ReviewSessionPage},
  data() {
    return {
        options: [{
          value: '1',
